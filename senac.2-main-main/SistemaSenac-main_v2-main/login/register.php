...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Restante do código para processar a senha, email e inserção no banco de dados...
}
 // Verificar o perfil selecionado
 $perfil = $_POST["tipo"];

 if ($perfil == "aluno") {
     // Ações específicas para o perfil de aluno
 } elseif ($perfil == "professor") {
     // Ações específicas para o perfil de professor
 } elseif ($perfil == "Coordenacao") {
     // Ações específicas para o perfil de coordenação
 } elseif ($perfil == "Gestor") {
     // Ações específicas para o perfil de gestor
 }
